...
- **Add Calon Afirmasi to Spreadsheet**: Menambahkan data calon afirmasi baru atas nama ananda Riza mahfudzi (nandariza856@gmail.com) ke dalam file Excel `petugas afirmasi.xlsx`.
